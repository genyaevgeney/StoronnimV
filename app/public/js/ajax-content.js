					...
					$.each(data, function(index,data) {
						...
						<div class=\"col-md-10 col-lg-6 StoronnimV-news-section__news\">
							<div class=\"StoronnimV-news-section__news-content\">
								<img src=\"storage/images/`+ data.title_image +`\" alt=\"` + data.title + `\" class=\"StoronnimV-news-section__news-image\">
								<div class=\"StoronnimV-news-section__text-div\">
									<div class=\"StoronnimV-news-section__wrap-main-text\">
										<a href=\"#\" class=\"StoronnimV-news-section__heading\">` + data.title + `</a>
										<p class=\"StoronnimV-news-section__description\">` + data.content + `</p>
									</div>
							...
							<div class=\"StoronnimV-news-section__news-date-div\">
								<span class=\"StoronnimV-news-section__month\">`+ month +`</span>
								<span class=\"StoronnimV-news-section__day\">`+ day +`</span>
							</div>
						</div>
						<!-- end of a piece of news -->`;
