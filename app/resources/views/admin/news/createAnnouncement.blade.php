        ...
        <form method="post" action="/news/store" enctype="multipart/form-data">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h4>Заповніть форму щоб додати анонс</h4>
                </div>
                @if ($errors->any())
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="event_date">Дата проведення заходу</label>
                        <input class="form-control" id="event_date" type="date" name="event_date" 
                               value="{{ old('event_date') }}">
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="hidden" id="type" name="type" value="announce">
                    </div>
                    <div class="form-group">
